...
const FloatingElements = () => {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      {/* Main floating circles - Reduced size and blur for mobile */}
      <motion.div
      ...
      {/* Remove some elements on mobile for better performance */}
      <motion.div
...
const ProfessionalPortfolio = () => {
  ...
  useEffect(() => {
    ...
    const observerOptions = {
      ...
      rootMargin: '-60px 0px -60px 0px' // Smaller margin for mobile
    };
  ...
  return (
    <div className="bg-slate-50 text-slate-900 min-h-screen overflow-x-hidden">
      ...
      <motion.div
        className="hidden sm:block fixed w-6 h-6 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full pointer-events-none z-50 mix-blend-difference"
        animate={{
          x: cursorPosition.x - 12,
          y: cursorPosition.y - 12,
          scale: 1
      ...
      <section id="home" className="min-h-screen flex items-center bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/30 relative overflow-hidden pt-16 sm:pt-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-12 sm:py-0">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              ...
              <motion.h2 
                className="text-xl sm:text-2xl lg:text-3xl font-medium text-slate-600 mb-6 sm:mb-8"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.4 }}
              >
              ...
              <motion.p 
                className="text-base sm:text-lg text-slate-600 mb-8 sm:mb-10 max-w-xl"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.6 }}
              >
              ...
              >
                <motion.button
                  onClick={handleDownload}
                  className="px-4 py-2 sm:px-6 sm:py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 flex items-center text-sm sm:text-base"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <FiDownload className="mr-2" />
                ...
                <motion.button
                  onClick={() => scrollToSection('projects')}
                  className="px-4 py-2 sm:px-6 sm:py-3 bg-white text-indigo-600 border border-indigo-200 rounded-lg font-medium shadow hover:shadow-md transition-all duration-300 flex items-center text-sm sm:text-base"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <FiCode className="mr-2" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
              viewport={{ once: true, margin: "-100px" }}
              className="bg-slate-50 rounded-xl p-6 sm:p-8 shadow-sm"
            >
              <h3 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6 text-slate-800">Contact Information</h3>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start">
                  <FiMail className="text-indigo-600 mt-0.5 sm:mt-1 mr-3 sm:mr-4" size={18} />
                  <div>
                    <div className="text-xs sm:text-sm text-slate-500">Email</div>
                    <a href={`mailto:${portfolioData.email}`} className="text-sm sm:text-base text-slate-800 hover:text-indigo-600 transition-colors">
                      {portfolioData.email}
                    </a>
                  </div>
                </div>
                <div className="flex items-start">
                  <FiPhone className="text-indigo-600 mt-0.5 sm:mt-1 mr-3 sm:mr-4" size={18} />
                  <div>
                    <div className="text-xs sm:text-sm text-slate-500">Phone</div>
                    <a href={`tel:${portfolioData.phone.replace(/\s+/g, '')}`} className="text-sm sm:text-base text-slate-800 hover:text-indigo-600 transition-colors">
                      {portfolioData.phone}
                    </a>
                  </div>
                </div>
                <div className="flex items-start">
                  <FiMapPin className="text-indigo-600 mt-0.5 sm:mt-1 mr-3 sm:mr-4" size={18} />
                  <div>
                    <div className="text-xs sm:text-sm text-slate-500">Location</div>
                    <div className="text-sm sm:text-base text-slate-800">{portfolioData.location}</div>
                  </div>
                </div>
              </div>
              
              <div className="mt-6 sm:mt-8">
                <h4 className="text-xs sm:text-sm font-semibold text-slate-500 mb-3 sm:mb-4">CONNECT WITH ME</h4>
                <div className="flex space-x-3 sm:space-x-4">
                  <motion.a
                    ...
                    whileHover={{ y: -3 }}
                  >
                    <FiGithub size={18} className="text-slate-800" />
                  </motion.a>
                  <motion.a
                    href={portfolioData.social.linkedin}
                    target="_blank"
                    ...
                    whileHover={{ y: -3 }}
                  >
                    <FiLinkedin size={18} className="text-blue-700" />
                  </motion.a>
                  <motion.a
                    href={portfolioData.social.instagram}
                    target="_blank"
                    ...
                    whileHover={{ y: -3 }}
                  >
                    <FiInstagram size={18} className="text-pink-600" />
                  </motion.a>
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {portfolioData.projects.map((project) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
              >
                <div className="h-40 sm:h-48 bg-slate-200 relative overflow-hidden">
                  <img 
                    src={project.image} 
                    alt={project.title} 
                    className="w-full h-full object-cover"
                ...
                <div className="p-5 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-bold mb-2 text-slate-800">{project.title}</h3>
                  <p className="text-sm sm:text-base text-slate-600 mb-3 sm:mb-4">{project.description}</p>
                  <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-3 sm:mb-4">
                    {project.tech.map((tech) => (
                      <span 
                        key={tech} 
                        className="px-2 py-0.5 sm:px-3 sm:py-1 bg-indigo-50 text-indigo-700 text-xs rounded-full"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="flex flex-col sm:flex-row sm:space-x-3 space-y-2 sm:space-y-0">
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-3 py-1.5 sm:px-4 sm:py-2 bg-slate-100 text-slate-800 rounded-lg text-xs sm:text-sm font-medium flex items-center justify-center"
                      whileHover={{ scale: 1.05 }}
                    >
                      <FiGithub className="mr-1.5 sm:mr-2" /> Code
                    </motion.a>
                    <motion.a
                      href={project.website}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-3 py-1.5 sm:px-4 sm:py-2 bg-indigo-600 text-white rounded-lg text-xs sm:text-sm font-medium flex items-center justify-center"
                      whileHover={{ scale: 1.05 }}
                    >
                      <FiExternalLink className="mr-1.5 sm:mr-2" /> Live Demo
                    </motion.a>
                  </div>
                </div>
              </motion.div>
